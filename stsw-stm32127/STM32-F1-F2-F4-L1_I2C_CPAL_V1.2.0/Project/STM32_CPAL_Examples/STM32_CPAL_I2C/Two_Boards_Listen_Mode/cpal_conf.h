/**
  ******************************************************************************
  * @file    Project/STM32_CPAL_Examples/STM32_CPAL_I2C/Two_Boards_Listen_Mode/cpal_conf.h 
...
/* This define must be uncommented for this example to allow CPAL library the use of I2C1 device when using
   STM3210C-EVAL (Connectivity line), STM32L152-EVAL (STM32L1xx Ultra Low Power Medium-Density) or STM32L152D-EVAL 
  (STM32L1xx Ultra Low Power High-Density) or STM322xG_EVAL and STM324xG_EVAL evaluation boards */
...
/* This define must be uncommented for this example. */
...
/* This define must be uncommented when DMA programming Model is selected to communicate and I2CX Device 
   is set as master and will receive one byte from other board */
...
/* Select which Closing communication Method is used for master receiver 
   Refer To Reference Manual document (available in www.st.com) for more details */
...
/* Communication is handled by CPAL_I2C_TXTC_UserCallback and CPAL_I2C_RXTC_UserCallback.
...
#define CPAL_I2C_TIMEOUT_MIN            ((uint32_t)0x00000100)
