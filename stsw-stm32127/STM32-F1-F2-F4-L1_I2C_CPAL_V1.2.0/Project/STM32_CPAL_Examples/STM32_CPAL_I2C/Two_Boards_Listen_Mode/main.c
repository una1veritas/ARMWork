/**
  ******************************************************************************
  * @file    Project/STM32_CPAL_Examples/STM32_CPAL_I2C/Two_Boards_Listen_Mode/main.c 
...
const uint8_t tSignal[]       = "STM32 CPAL 2xBoards Example: Signal Period ";
...
#if defined (USE_STM32L152_EVAL) || defined (USE_STM32L152D_EVAL) || defined (USE_STM3210C_EVAL)  
  NVIC_InitStructure.NVIC_IRQChannel = TIM6_IRQn;
#elif defined (USE_STM32100E_EVAL)|| defined (USE_STM322xG_EVAL) || defined (USE_STM324xG_EVAL)
