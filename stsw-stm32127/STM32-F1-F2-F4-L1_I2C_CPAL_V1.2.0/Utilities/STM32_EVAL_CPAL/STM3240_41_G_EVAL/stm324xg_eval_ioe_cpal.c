/**
  ******************************************************************************
  * @file    STM32_EVAL_CPAL/STM324xG_EVAL/stm324xg_eval_ioe_cpal.c.c
  ...
  *          devices.
  *          
  *          @note This file is a modified version of STM324xG_EVAL_ioe.c driver;
  ...
  */
  ...
  /* File Info : ---------------------------------------------------------------
    ...
    UNSUPPORTED FEATURES:
      - Row ADC Feature is not supported (not implemented on STM324xg-EVAL board)
  ----------------------------------------------------------------------------*/
