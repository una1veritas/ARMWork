/**
  ******************************************************************************
  * @file    STM32_EVAL_CPAL/Common/stm32_eval_i2c_ee_cpal.c
  ...
  *          from/to this memory. 
  *        
  *          @note This file is a modified version of stm32_eval_i2c_ee.c driver;
  ...
  *                completed . Stopping transfer tasks are performed into DMA 
...
#ifdef CPAL_USE_I2C3 
 sEE_InitTypeDef sEE3_DevStructure = {&I2C3_DevStructure, 0, 0, 0, sEE_STATE_IDLE};          /* Initialize All structure parameters to 0 */  
#endif /* CPAL_USE_I2C3 */
...
#if defined (STM32F2XX) || defined (STM32F4XX)
#ifdef CPAL_USE_I2C3 
 sEE_WriteTypeDef sEE3_WriteStructure = {0, 0, pNULL, 0, 0, 0};          /* Initialize All structure parameters to 0 */  
#endif /* CPAL_USE_I2C3 */
#endif /* STM32F2XX  || STM32F4XX */
...
#if defined (STM32F2XX) || defined (STM32F4XX)
#ifdef CPAL_USE_I2C3 
CPAL_TransferTypeDef  sEE3_TXTransfer = { 
                        /* Initialize TX Transfer structure */
                        pNULL,
                        0,
                        0,
...
CPAL_TransferTypeDef  sEE3_RXTransfer = {
                        /* Initialize RX Transfer structure */
                        pNULL,
                        0,
                        0,
