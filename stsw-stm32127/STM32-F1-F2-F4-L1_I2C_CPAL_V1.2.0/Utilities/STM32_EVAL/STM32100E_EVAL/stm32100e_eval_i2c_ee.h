/**
  ******************************************************************************
  * @file    stm32100e_eval_i2c_ee.h
  * @author  MCD Application Team
  * @version V5.0.1
  * @date    05-March-2012
  * @brief   This file contains all the functions prototypes for the stm32100e_eval_i2c_ee
  *          firmware driver.
  ******************************************************************************
  * @attention
  *
...
#ifndef __STM32100E_EVAL_I2C_EE_H
#define __STM32100E_EVAL_I2C_EE_H
...
/** @addtogroup STM32100E_EVAL_I2C_EE
  * @{
  */  

/** @defgroup STM32100E_EVAL_I2C_EE_Exported_Types
  * @{
  */ 
...
/** @defgroup STM32100E_EVAL_I2C_EE_Exported_Constants
  * @{
  */
...
/* Uncomment the following line to use the default sEE_TIMEOUT_UserCallback() 
   function implemented in stm32100e_eval_i2c_ee.c file.
...
/* For M24C32 and M24C64 devices, E0,E1 and E2 pins are all used for device 
  ...
  Harware connection on the board (on STM32100E-EVAL board E0 = E1 = E2 = 0) */
...
/** @defgroup STM32100E_EVAL_I2C_EE_Exported_Macros
  * @{
  */    
/**
  * @}
...
/** @defgroup STM32100E_EVAL_I2C_EE_Exported_Functions
  * @{
  */ 
...
/* sEE_TIMEOUT_UserCallback() function is called whenever a timeout condition 
   ...
   define USE_DEFAULT_TIMEOUT_CALLBACK in stm32100e_eval_i2c_ee.h file.
...
/* Start and End of critical section: these callbacks should be typically used
   to disable interrupts when entering a critical section of I2C communication
   You may use default callbacks provided into this driver by uncommenting the 
   define USE_DEFAULT_CRITICAL_CALLBACK in stm32100e_eval_i2c_ee.h file..
   Or you can comment that line and implement these callbacks into your 
   application */
...
#endif /* __STM32100E_EVAL_I2C_EE_H */
/**
  * @}
  */
