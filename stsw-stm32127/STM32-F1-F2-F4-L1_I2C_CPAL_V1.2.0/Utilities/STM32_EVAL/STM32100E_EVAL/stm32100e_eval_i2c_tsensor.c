/**
  ******************************************************************************
  * @file    stm32100e_eval_i2c_tsensor.c
  * @author  MCD Application Team
  * @version V5.0.1
  * @date    05-March-2012
  * @brief   This file provides a set of functions needed to manage the I2C LM75 
  *          temperature sensor mounted on STM32100E-EVAL board. 
  ...
  *          performed in LM75_LowLevel_Init() function declared in stm32100e_eval.c 
  *          file.
  *            
  *          Note:
  *          -----    
...
/* Includes ------------------------------------------------------------------*/
#include "stm32100e_eval_i2c_tsensor.h"
...
/** @addtogroup STM32100E_EVAL_I2C_TSENSOR
  * @brief      This file includes the LM75 Temperature Sensor driver of 
  *             STM32100E-EVAL board.
  * @{
  */ 

/** @defgroup STM32100E_EVAL_I2C_TSENSOR_Private_Types
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM32100E_EVAL_I2C_TSENSOR_Private_Defines
  * @{
  */ 
...
/** @defgroup STM32100E_EVAL_I2C_TSENSOR_Private_Macros
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM32100E_EVAL_I2C_TSENSOR_Private_Variables
  * @{
  */ 
...
/** @defgroup STM32100E_EVAL_I2C_TSENSOR_Private_Function_Prototypes
  * @{
  */ 
...
/** @defgroup STM32100E_EVAL_I2C_TSENSOR_Private_Functions
  * @{
  */ 
