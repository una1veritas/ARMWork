/**
  ...
  *          performed in sEE_LowLevel_Init() function declared in stm32100e_eval.c 
  *          file.
...
/** @addtogroup STM32100E_EVAL_I2C_EE
  * @brief      This file includes the I2C EEPROM driver of STM32100E-EVAL board.
  * @{
  */ 

/** @defgroup STM32100E_EVAL_I2C_EE_Private_Types
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM32100E_EVAL_I2C_EE_Private_Defines
  * @{
  */  
/**
  * @}
...
/** @defgroup STM32100E_EVAL_I2C_EE_Private_Macros
  * @{
  */
/**
  * @}
...
/** @defgroup STM32100E_EVAL_I2C_EE_Private_Variables
  * @{
  */
...
/** @defgroup STM32100E_EVAL_I2C_EE_Private_Function_Prototypes
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM32100E_EVAL_I2C_EE_Private_Functions
  * @{
  */ 
...
uint32_t sEE_WaitEepromStandbyState(void)      
{
  ...
  /* Keep looping till the slave acknowledge his address or maximum number 
     ...
     in stm32100e_eval_i2c_ee.h file) */
  while (1)
  {
    /*!< Send START condition */
    I2C_GenerateSTART(sEE_I2C, ENABLE);
