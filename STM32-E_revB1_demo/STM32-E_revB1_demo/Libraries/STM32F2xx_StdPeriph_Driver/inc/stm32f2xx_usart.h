...
#define USART_StopBits_1                     ((uint16_t)0x0000) /*<! The 1 Stop bit is available for all USARTs and UARTs */
#define USART_StopBits_0_5                   ((uint16_t)0x1000) /*<! The 0.5 Stop bit is not available for UARTs (UART4 & UART5) */
#define USART_StopBits_2                     ((uint16_t)0x2000) /*<! The 2 Stop bits is available for all USARTs and UARTs */
#define USART_StopBits_1_5                   ((uint16_t)0x3000) /*<! The 1.5 Stop bit is not available for UARTs (UART4 & UART5) */
