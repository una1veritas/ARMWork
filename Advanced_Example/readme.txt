...
*-----------------------------------------------------------------------------*
 ...
 - TempSensor (through IOEpander when using STM3210C-EVAL and STM322xG-EVAL and through LM75 device 
   when using STM32100E-EVAL): Periodically (using a timer interrupt) the temperature 
   Sensor is read and the temperature value is stored into the EEPROM memory. 
...
@par Directory contents 
  ...
  - Advanced_Example/system_stm32xxxx.c   STM32xxxx devices system source file (xxxx can be : f10x or l1xx or f2xx)
  - Advanced_Example/stm32xxxx_conf.h     Library Configuration file for STM32xxxx devices (xxxx can be : f10x or l1xx or f2xx)
...
@par Hardware and Software environment 
  ...
  - This example has been tested with STMicroelectronics STM3210C-EVAL RevB
    (Connectivity line), STM32100E-EVAL RevB (High-Density Value line) and
    STM322xG-EVAL board RevB evaluation boards and can be easily tailored to
  ...
  - STM3210C-EVAL Set-up 
    ...
    - No additional Hardware connections are required.  
