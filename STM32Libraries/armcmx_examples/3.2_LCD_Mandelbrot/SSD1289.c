...
{ 
  LCD_CtrlLinesConfig();
  delay_us(300); //Delay(3000);
  LCD_FSMCConfig();
  delay_us(300); // Delay(3000);
  TIM_Config();
  LCD_BackLight(100);
  
  LCD_WriteReg(0x0007,0x0021);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x0000,0x0001);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x0007,0x0023);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x0010,0x0000);    delay_us(9); //Delay(90);
  LCD_WriteReg(0x0007,0x0033);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x0011,0x6830);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x0002,0x0600);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x0012,0x6CEB);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x0003,0xA8A4);    delay_us(5); //Delay(50);                       
  LCD_WriteReg(0x000C,0x0000);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x000D,0x080C);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x000E,0x2B00);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x001E,0x00B0);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x0001,0x2b3F);    delay_us(5); //Delay(50);  //RGB
  LCD_WriteReg(0x0005,0x0000);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x0006,0x0000);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x0016,0xEF1C);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x0017,0x0103);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x000B,0x0000);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x000F,0x0000);    delay_us(5); //Delay(50);  
  LCD_WriteReg(0x0041,0x0000);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x0042,0x0000);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x0048,0x0000);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x0049,0x013F);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x004A,0x0000);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x004B,0x0000);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x0044,0xEF00);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x0045,0x0000);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x0046,0x013F);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x0030,0x0707);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x0031,0x0204);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x0032,0x0204);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x0033,0x0502);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x0034,0x0507);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x0035,0x0204);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x0036,0x0204);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x0037,0x0502);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x003A,0x0302);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x002F,0x12BE);    delay_us(5); //Delay(50);           
  LCD_WriteReg(0x003B,0x0302);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x0023,0x0000);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x0024,0x0000);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x0025,0x8000);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x004f,0x0000);    delay_us(5); //Delay(50);
  LCD_WriteReg(0x004e,0x0000);    delay_us(5); //Delay(50);
}
