...
#ifndef __STM322xG_AUDIOCODEC_H
#define __STM322xG_AUDIOCODEC_H
...
/** @defgroup STM32_AUDIO_CODEC_Exported_Defines
  * @{
  */ 
/*------------------------------------
...
///This define should be removed (and its relative code). Used for debug purpose only.
///#define AUDIO_USE_MACROS
/**
  * @}
  */ 

/** @defgroup STM32_AUDIO_CODEC_Exported_TypesDefinitions
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM32_AUDIO_CODEC_Exported_Macros
  * @{
  */ 
...
/** @defgroup STM32_AUDIO_CODEC_Exported_Variables
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM32_AUDIO_CODEC_Exported_FunctionsPrototype
  * @{
  */
/*-----------------------------------
                           Generic functions 
...
/*------------------------------------
                 SPI extended Initialization function
                                     -----------------------------------------*/
...
/* Codec_TIMEOUT_UserCallback() function is called whenever a timeout condition 
   ...
   define USE_DEFAULT_TIMEOUT_CALLBACK in stm322xg_audio_codec.h file.
