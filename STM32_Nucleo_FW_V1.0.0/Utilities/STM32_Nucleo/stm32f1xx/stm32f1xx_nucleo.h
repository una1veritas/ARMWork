...
/** @defgroup STM32F1XX_NUCLEO_LOW_LEVEL_Exported_Macros
  * @{
  */
/**
...
/** @addtogroup STM32F1XX_NUCLEO_LOW_LEVEL_LED
  * @{
  */
#define LEDn                             1
...
/** @defgroup STM32F1XX_NUCLEO_LOW_LEVEL_Exported_Functions
  * @{
  */
...
/* Functions to configure and manage the STM32F1xx resources (SPI and ADC) used to drive 
