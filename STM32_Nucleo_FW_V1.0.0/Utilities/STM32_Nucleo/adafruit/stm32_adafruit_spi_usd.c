/**
  ******************************************************************************
  * @file    stm32_adafruit_spi_usd.c
  * @author  MCD Application Team
  * @version V1.0.0
  * @date    11-February-2014
  * @brief   This file provides a set of functions needed to manage the SPI SD 
  *          Card memory mounted on adafruit 1.8" TFT shield.
  *          It implements a high level communication layer for read and write 
  *          from/to this memory. The needed hardware resources (SPI and GPIO) 
  *          are defined in stm32_adafruit_spi_usd.h file, and the initialization is 
  *          performed in SD_LowLevel_Init() function declared in stm32_adafruit_spi_usd.c 
  *          file.
...
/** @addtogroup STM32_ADAFRUIT_SPI_USD
  * @brief      This file includes the SD card driver of ADAFRUIT boards.
  * @{
  */ 
...
/** @defgroup STM32_ADAFRUIT_SPI_USD_Private_Functions
  * @{
  */ 

/**
  * @brief  Initialize the SD mounted on adafruit 1.8" TFT shield.
  ...
  */
SD_Error SD_ADAFRUIT_Init(void)
{
  uint32_t i = 0;
