// 
// STM32F4DISCOVERYでLEDチカチカサンプルプロジェクト
//  (ちょっと寄り道ハードタイマーを使ったPWMで明滅させる編)
// 
...
// ディレクトリからコピーしたものです(core_cmInstr.hに修正あり※参照)
...
// 
// プロジェクトのビルド手順：
// プロジェクトアーカイブを展開して，生成されたディレクトリにカレントを
// 移して，makeを実行してください。
// 
// 実行方法：
// obj/*.hexをSTM32F4discoveryに好きな方法でロードして実行します。
// 
// 
// 参考サイト：
...
// 具体的な修正箇所は，inc/core_cmInstr.h.diffを参照のこと。
