...
#define DI_INIT()	DDRB  |= 0x02	/* Initialize port MMC DI as output */
#define DI_H()		PORTB |= 0x02	/* Set MMC DI "high" */
#define DI_L()		PORTB &= 0xFD	/* Set MMC DI "low" */

#define CK_INIT()	DDRB  |= 0x04	/* Initialize port MMC SCLK as output */
#define CK_H()		PORTB |= 0x04	/* Set MMC SCLK "high" */
#define	CK_L()		PORTB &= 0xFB	/* Set MMC SCLK "low" */

#define CS_INIT()	DDRB  |= 0x08	/* Initialize port MMC CS as output */
