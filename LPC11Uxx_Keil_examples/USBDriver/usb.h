...
/* USB BOS Descriptor. */
typedef __packed struct _USB_BOS_DESCRIPTOR {
  uint8_t  bLength;
  uint8_t  bDescriptorType;
  uint16_t wTotalLength;
...
typedef __packed struct _USB_SS_DEVICE_CAPABLITY_DESCRIPTOR {
  uint8_t  bLength;
  uint8_t  bDescriptorType;
...
typedef __packed struct _USB_DEVICE_CAPABLITY_DESCRIPTOR {
  uint8_t  bLength;
  uint8_t  bDescriptorType;
  uint8_t  bDeviceCapabilityType;
