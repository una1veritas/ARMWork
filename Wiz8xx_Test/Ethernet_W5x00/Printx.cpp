...
/*
size_t Printx::print(const __FlashStringHelper *ifsh)
{
...
size_t Printx::print(const String &s)
{
  size_t n = 0;
...
/*
size_t Printx::println(const __FlashStringHelper *ifsh)
{
  size_t n = print(ifsh);
  n += println();
  return n;
...
/*
size_t Printx::println(const String &s)
{
  size_t n = print(s);
  n += println();
  return n;
