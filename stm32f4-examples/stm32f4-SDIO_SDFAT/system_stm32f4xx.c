...
#warning "Olimex STM32-E407 param set is selected for PLLs."
...
#warning "STM32F4 Discovery's param set is selected for PLLs."
...
#else
#warning "stm 25MHz Dev. board setting is selected for PLLs."
