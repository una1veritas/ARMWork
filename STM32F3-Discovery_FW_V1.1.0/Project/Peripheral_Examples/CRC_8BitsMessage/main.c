/**
  ******************************************************************************
  * @file    CRC_8BitsCRCMessage/main.c 
...
static void CRC_Config8Bits(uint8_t poly);
static uint8_t CRC_Cal8Bits(uint8_t* data, uint32_t size);
...
int main(void)
{
  ...
  ComputedCRC = CRC_Cal8Bits(CRCBuffer, BUFFER_SIZE);
