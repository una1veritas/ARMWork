...
int main(void)
{
  ...
  /* Note : To ensure the lowest consumption when using the small packages (48 and 
     64 pin packages), the GPIO pins which are not present on these packages, must  
  ...
  /* Sleep Mode Entry 
      ...
      - Wakeup using EXTI Line (KEY Button PA.2)
   */  
  SleepMode_Measure();
