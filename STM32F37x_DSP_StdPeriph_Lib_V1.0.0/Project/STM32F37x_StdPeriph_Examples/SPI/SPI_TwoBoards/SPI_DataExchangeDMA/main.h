...
#define SPIx_TX_DMA_FLAG_TC              DMA1_FLAG_TC5
#define SPIx_TX_DMA_FLAG_GL              DMA1_FLAG_GL5
#define SPIx_RX_DMA_CHANNEL              DMA1_Channel4
#define SPIx_RX_DMA_FLAG_TC              DMA1_FLAG_TC4
#define SPIx_RX_DMA_FLAG_GL              DMA1_FLAG_GL4

#define SPI_DMAx_CLK                     RCC_AHBPeriph_DMA1
...
#define SPIx_NSS_GPIO_CLK                RCC_AHBPeriph_GPIOD
#define SPIx_NSS_SOURCE                  GPIO_PinSource6
