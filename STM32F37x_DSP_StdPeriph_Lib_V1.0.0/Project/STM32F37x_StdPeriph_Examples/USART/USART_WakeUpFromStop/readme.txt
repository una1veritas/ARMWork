...
First, the USART2 is configured to WakeUp from STOP with StartBitMethod(when any
data is received on RX line).
After configuration, the MCU enters STOP mode(WFI) and waits to be waken.
When a string is send to USART2 via the hyperterminal, the MCU WakeUp from stop,
...
@par Directory contents 
  ...
  - USART/USART_WakeUpFromStop/stm32f37x_conf.h    Library Configuration file
  - USART/USART_WakeUpFromStop/stm32f37x_it.c      Interrupt handlers
  - USART/USART_WakeUpFromStop/stm32f37x_it.h      Interrupt handlers header file
  - USART/USART_WakeUpFromStop/main.c              Main program
  - USART/USART_WakeUpFromStop/system_stm32f37x.c  STM32F37x system source file
