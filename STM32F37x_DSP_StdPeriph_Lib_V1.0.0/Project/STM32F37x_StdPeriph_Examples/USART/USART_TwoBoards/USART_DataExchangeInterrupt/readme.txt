...
In both boards(Board A or Board B), the data transfers is managed using USART2_IRQHandler 
in stm32f37x_it.c file when USART2 is used.
...
@par Directory contents 
  ...
  - USART/USART_TwoBoards/USART_DataExchangeInterrupt/stm32f37x_conf.h    Library Configuration file
  - USART/USART_TwoBoards/USART_DataExchangeInterrupt/stm32f37x_it.c      Interrupt handlers
  - USART/USART_TwoBoards/USART_DataExchangeInterrupt/stm32f37x_it.h      Interrupt handlers header file
  ...
  - USART/USART_TwoBoards/USART_DataExchangeInterrupt/system_stm32f37x.c  STM32F37x system source file
