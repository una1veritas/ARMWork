/**
  ******************************************************************************
  * @file    SDADC/SDADC_TempMeasurement/stm32f37x_it.c 
...
/* Private macro -------------------------------------------------------------*/
/* Private variables ---------------------------------------------------------*/
extern __IO int16_t AvrgRegularConvData;
int16_t RegularConvData = 0;
uint16_t RegularConvCounter = 0;
int32_t SumRegularConvData = 0;
...
void SDADC1_IRQHandler(void)
{
  if(SDADC_GetFlagStatus(SDADC1, SDADC_FLAG_REOC) != RESET)
  {
    ...
    RegularConvData = SDADC_GetConversionValue(SDADC1);
