/**
  ******************************************************************************
  * @file    CEC/CEC_DataExchange/stm32f37x_it.c 
...
uint8_t ByteNumber = 0, StartSending = 0;
...
/******************************************************************************/
/**
* @brief  This function handles EXTI Lines 2 interrupts requests.
* @param  None
* @retval None
*/
...
{  
  ...
  /* Set variable to start transmission */ 
  StartSending = 1;
}
