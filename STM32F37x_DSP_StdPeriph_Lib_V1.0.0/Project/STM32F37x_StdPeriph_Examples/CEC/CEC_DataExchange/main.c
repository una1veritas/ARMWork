...
int main(void)
{
  ...
  /* Initialize LEDs and JoyStick Button available on STM32373C_EVAL board */
  ...
  /* Configure the Joystick buttons and their associated EXTI Line */
...
#if defined (DEVICE_1)
  MyLogicalAddress = DEVICE_ADDRESS_1;
  MyFollowerAddress = DEVICE_ADDRESS_2;
#elif defined (DEVICE_2)
  MyLogicalAddress = DEVICE_ADDRESS_2;
  ...
  HeaderBlockValueToSend = (((MyLogicalAddress & 0xF) << 4)|(MyFollowerAddress & 0xF));
...
void CEC_Config(void)
{
  ...
  /* Configure GPIOB Pin 8 as Output open drain (CEC line)*/
