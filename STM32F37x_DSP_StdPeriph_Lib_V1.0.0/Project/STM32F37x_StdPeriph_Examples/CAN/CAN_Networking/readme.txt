/**
  @page CAN_Networking CAN CAN_Networking example
  ...
  * @brief   Description of the CAN CAN_Networking example.
  ******************************************************************************
  *
...
This program behaves as follow:
...
@par Directory contents 
  ...
  - CAN/CAN_Networking/stm32f37x_conf.h    Library Configuration file
  - CAN/CAN_Networking/stm32f37x_it.c      Interrupt handlers
  - CAN/CAN_Networking/stm32f37x_it.h      Interrupt handlers header file
  - CAN/CAN_Networking/main.c              Main program
  - CAN/CAN_Networking/main.h              Main program header file
  - CAN/CAN_Networking/system_stm32f37x.c  STM32F37x system source file
