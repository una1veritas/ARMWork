/**
  ******************************************************************************
  * @file    NVIC/NVIC_IRQPriority/stm32f37x_it.c 
...
{
  /* If the SEL_BUTTON_EXTI IRQ Handler (EXTI9_5_IRQHandler) was preempted
     by SysTick Handler */
...
/**
  * @brief  This function handles EXTI Lines 2 and Touch sense interrupts requests.
  * @param  None
  * @retval None
  */
