...
int main(void)
{
  ...
  /* Initialize the KEY and SEL buttons mounted on STM32373C-EVAL board */
...
{ 
  ...
  TIM_TimeBaseStructure.TIM_Prescaler = ((SystemCoreClock/720) - 1);
  ...
  TIM_PrescalerConfig(TIM2, ((SystemCoreClock/720) - 1), TIM_PSCReloadMode_Immediate);
  TIM_PrescalerConfig(TIM3, ((SystemCoreClock/720) - 1), TIM_PSCReloadMode_Immediate);
  TIM_PrescalerConfig(TIM4, ((SystemCoreClock/720) - 1), TIM_PSCReloadMode_Immediate);
