...
/* Private variables ---------------------------------------------------------*/
uint8_t Tx1Buffer[] = "/* STM32F37x I2C Firmware Library EEPROM driver example: \
...
uint8_t Tx2Buffer[] = "/* STM32F37x I2C Firmware Library EEPROM driver example : \
...
int main(void)
{
  ...
  LCD_DisplayStringLine(LCD_LINE_0, (uint8_t*)"STM32F37x FW Library");
