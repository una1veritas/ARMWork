...
The example software perform the following actions:
 - At startup, Boards A & B are both in slave receiver mode and wait for messages 
   to be received.
 - When a push button (key or tamper) is pressed, for example on Board A, the master
   transmitter mode is activated and a message is sent to Board B containing
   identification of the action relative to the push button.
 ...
 - When Key is pressed Board A send specific message (tSignal1) to Board B and set 
   the period of Timer to 3 seconds. When Tamper is pressed specific message (tSignal2)
   is sent and the period of Timer is set to 0.75 seconds.
...
stm32f37x_i2c_cpal_conf.h file by commenting or uncommenting these defines in Section 2 (Transfer
...
@par Directory contents 
  ...
  - I2C/I2C_TwoBoards/stm32f37x_conf.h                   Library Configuration file
  - I2C/I2C_TwoBoards/stm32f37x_it.c                     Interrupt handlers
  - I2C/I2C_TwoBoards/stm32f37x_it.h                     Interrupt handlers header file
  - I2C/I2C_TwoBoards/main.c                             Main program
  - I2C/I2C_TwoBoards/main.h                             Main program header file   
  - I2C/I2C_TwoBoards/system_stm32f37x.c                 STM32F37x system source file
  - I2C/I2C_TwoBoards/stm32f37x_i2c_cpal_conf.h          CPAL Library Configuration file
  - I2C/I2C_TwoBoards/stm32f37x_i2c_cpal_usercallback.c  CPAL Usercallbacks definition
...
@par Hardware and Software environment
 ...
 - STM32373C-EVAL Set-up :
   Then these two boards should be connected as follows:
     - Connect I2C2 SCL pin (PA9) to I2C2 SCL pin (PA9)
...
In order to make the program work, you must do the following :
 ...
 - Add the following files the project source list
     - Libraries/STM32F37x_I2C_CPAL_Driver/src/stm32f37x_i2c_cpal.c
     - Libraries/STM32F37x_I2C_CPAL_Driver/src/stm32f37x_i2c_cpal_hal.c
     - Project/STM32F37x_StdPeriph_Templates/stm32f37x_i2c_cpal_usercallback.c
