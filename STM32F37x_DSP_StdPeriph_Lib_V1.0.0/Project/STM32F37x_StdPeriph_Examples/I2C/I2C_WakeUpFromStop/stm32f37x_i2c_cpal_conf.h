/**
  ******************************************************************************
  * @file    I2C/I2C_WakeUpFromStop/stm32f37x_i2c_cpal_conf.h
...
------ After configuring CPAL firmware functionality , You should proceed by configuring hardware used with CPAL
       (please refer to stm32f37x_i2c_cpal_hal.h file).
...
------ Callbacks are routines that let you insert your own code in different stages of communication and for handling
       device errors. Their prototypes are declared by the CPAL library (if the relative define in this stm32f37x_i2c_cpal_conf.h is enabled)
     ...
     your application (their prototypes are declared in stm32f37x_i2c_cpal.h file).
     ...
     Example of using CPAL_I2C_BERR_UserCallback :
             ...
             -2- Comment define relative to CPAL_I2C_BERR_UserCallback in stm32f37x_i2c_cpal_conf.h file:
...
------ The driver API functions Prototypes are in stm32f37x_i2c_cpal.h file.
...
/* This define must be uncommented for this example. In this example I2C2 device 
