/**
  ******************************************************************************
  * @file    RTC/RTC_Timer/stm32f37x_it.c 
...
void RTC_Alarm_IRQHandler(void)
{
  ...
  { 
    ...
    {
      /* Increment the counter of Alarm interrupts*/
      RTCAlarmCount++;
...
void EXTI2_TS_IRQHandler(void)
{
  ...
  if(EXTI_GetITStatus(DOWN_BUTTON_EXTI_LINE) != RESET)
  {
    if(RTCAlarmCount == 0)
    {
      ...
      /* Display Char on the LCD : XXX% */       
      LCD_DisplayChar(95, 287, (tmp / 10) +0x30);
      LCD_DisplayChar(95, 271, (tmp  % 10 ) +0x30);
      LCD_DisplayChar(95, 255, ':');
      LCD_DisplayChar(95, 239, (tmp1 / 10) +0x30);
      LCD_DisplayChar(95, 223, (tmp1  % 10 ) +0x30);
    }
    
    /* Clear the DOWN EXTI  pending bit */
