...
/******************************************************************************/
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
	...
	/* Detect STM32F4xxx Chip Revision nemui added */
	/* RevA have Errata, DeviceID has 0x0411(Same as STM32F2)! */
    if((DBGMCU->IDCODE & DBGMCU_IDCODE_DEV_ID) == 0x0413)	/* Rev Z Chip */
	{
