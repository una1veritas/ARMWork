...
#include "ff.h"				/* Nemui Changed */
static UINT rb =0;			/* Nemui Changed */

/* avoid extra function call in case we use fread (TVT) */
/* Nemui Changed */
static int READ(GifFileType* _gif,unsigned char * _buf,int _len){
	f_read((((GifFilePrivateType*)_gif->Private)->File), _buf, _len , &rb);
...
/* Nemui Changed */
GifFileType *
DGifOpenFileHandle(FIL* fp, int *Error)
{
...
DGifCloseFile(GifFileType *GifFile)
{
    ...
    if (Private->File && (f_close(Private->File) != 0)) {
