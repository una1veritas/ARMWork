...
void static __INLINE USARTClear(void)
{
  USARTStatus = 0;
  USARTCount = 0;
  USARTErrorCount = 0;
...
void static __INLINE USARTIgnore(void) { USARTDisregard = 1; }
void static __INLINE USARTAccept(void) { USARTDisregard = 0; }

void static __INLINE USARTNackEnable(void)
{ 
  LPC_USART->SCICTRL &= ~_BV(1);
}

void static __INLINE USARTNackDisable(void)
{ 
  LPC_USART->SCICTRL |= _BV(1);
}

void static __INLINE USARTProtocolT0(void)
{ 
  LPC_USART->SCICTRL &= ~_BV(2);
}

void static __INLINE USARTProtocolT1(void)
{ 
  LPC_USART->SCICTRL |= _BV(2);
}
