...
/*               for  ST M29W160ET (16-bit Bus) on                     */
/*               NXP LPC4300 eval board rev 4.1                        */ 
/*                                                                     */
/***********************************************************************/
...
int Init (unsigned long adr, unsigned long clk, unsigned long fnc) {
  base_adr = adr;
	...
	*(uint32_t *)0x40005208 = 0x0000000F; // 04;      // CS0: WAITOEN = 1
	*(uint32_t *)0x4000520C = 0x0000001F; // 09;      // CS0: WAITRD = 6 

//  _WDWORD(0x40005208, 0x00000000);      /* CS0: WAITOEN = 0 */
//  _WDWORD(0x4000520C, 0x00000006);      /* CS0: WAITRD = 6 */
	return (0);
}
