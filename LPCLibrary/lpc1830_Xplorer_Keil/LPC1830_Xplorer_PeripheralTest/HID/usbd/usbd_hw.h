/**********************************************************************
* $Id$		usbd_hw.h				2011-06-02
*//**
* @file		usbd_hw.h
* @brief	Hardware API structure definitions.
* @version	1.0
* @date		02. June. 2011
...
typedef struct USBD_HW_API
{
   ...
   *  Function to configure USB device controller to wakeup on remote events.
   *
   ...
   *  \note User's USB_WakeUpCfg() is registered with stack by setting the corresponding member
