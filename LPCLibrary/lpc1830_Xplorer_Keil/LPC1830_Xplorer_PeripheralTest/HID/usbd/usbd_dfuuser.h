/**********************************************************************
* $Id$		usbd_dfuuser.h				2011-06-02
*//**
* @file		usbd_dfuuser.h
* @brief	USB Device Firmware Upgrade Class API structure definitions.
* @version	1.0
* @date		02. June. 2011
...
typedef struct USBD_DFU_API
{
   ...
   *
   *  \param[in] hUsb Handle to the USB device stack.
   *  \param[in, out] param Structure containing HID function driver module initialization parameters.
