/**********************************************************************
* $Id$		usbd_core.h				2011-06-02
*//**
* @file		usbd_core.h
* @brief	USB Core API structure definitions.
* @version	1.0
* @date		02. June. 2011
...
#else
INLINE void USB_SetSpeedMode(USB_CORE_CTRL_T* pCtrl, uint8_t mode)
#endif
{
