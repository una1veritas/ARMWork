...
void Init_EMAC(void)
{
  int id1, id2, tout, regv, phy = 0;
  int phy_linkstatus_reg, phy_linkstatus_mask;
...
#else
  //scu_pinmux(0xC ,1 , (MD_EHS | MD_PLN | MD_EZI | MD_ZI), FUNC3); 	// ENET_MDC: PC_1 -> FUNC3	// MD_EHS 
  scu_pinmux(0x2 ,0 , (MD_EHS | MD_PLN | MD_EZI | MD_ZI), FUNC7); 	// ENET_MDC: P2_0 -> FUNC7	// MD_EHS 
  ...
  scu_pinmux(0x1 ,16 , (MD_EHS | MD_PLN | MD_EZI | MD_ZI), FUNC7); 	// ENET_RXDV: P1_16 -> FUNC7	 	
#endif
