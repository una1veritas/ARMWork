...
#define IS_FLASH_OTP_ADDRESS(ADDRESS) (((ADDRESS) >= 0x1FFF7800) && ((ADDRESS) < 0x1FFF7A0F)) 
/**
  * @}
  */ 
...
/** @defgroup BOR_Reset_Level 
  * @{
  */  
#define OB_BOR_Level_3          ((uint8_t)0x00)  /* Supply voltage ranges from 2.70 to 3.60 V */
#define OB_BOR_Level_2          ((uint8_t)0x04)  /* Supply voltage ranges from 2.40 to 2.70 V */
#define OB_BOR_Level_1          ((uint8_t)0x08)  /* Supply voltage ranges from 2.10 to 2.40 V */
#define OB_BOR_Level_Off        ((uint8_t)0x0C)  /* Supply voltage ranges from 1.62 to 2.10 V */
#define IS_OB_BOR(LEVEL) (((LEVEL) == OB_BOR_Level_1) || ((LEVEL) == OB_BOR_Level_2) ||\
                          ((LEVEL) == OB_BOR_Level_3) || ((LEVEL) == OB_BOR_Level_Off))
